...
Mark-recapture models for analysing simulated capture history data. These models are simplified versions of the models presented in maps_models_notebook. Simplifications are:
